...
export const Timeline = ({
  ...
  return (
    <div
      className="w-full bg-white dark:bg-neutral-950 font-sans md:px-10 rounded-lg border-l-2 border-neutral-950 dark:border-blue-800"
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          ...
          I&apos;ve been learning software skills and solving problems on different platforms for the past 2 years. Here&apos;s
